    ...
    <section id="services" className="py-section relative">
      <div className="site-container">
        ...
        <div className="border-t border-white/[0.04]">
          {t.items.map((service) => {
            const originalService = services.find((s) => s.id === service.id) || services[0];
            return (
              <div
                key={service.id}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl">
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {originalService.technologies.map((tech) => (
                                <span
                                  key={tech}
                          ...
                          <div>
                            <span className="section-label mb-3 block">{t.capabilitiesLabel}</span>
